 ...
 implements HelloApp.HelloOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    _methods.put ("EqOfMotion", new java.lang.Integer (0));
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // HelloApp/Hello/EqOfMotion
       {
         String v0 = in.read_string ();
         String t = in.read_string ();
         String a = in.read_string ();
         String $result = null;
         $result = this.EqOfMotion (v0, t, a);
         out = $rh.createReply();
